        ...
        <aside className="sticky top-0 hidden h-screen w-[288px] shrink-0 flex-col border-r border-white/[0.06] bg-gradient-to-b from-[#0d1522] to-[#0a111d] lg:flex">
          ...
          <div className="space-y-3 border-t border-white/[0.06] p-4">
            ...
            <div className="rounded-2xl border border-emerald-400/20 bg-emerald-400/[0.05] p-4">
              ...
              <p className="mt-2 break-all font-mono text-[11px] leading-4 text-slate-400">
        ...
        <section className="min-w-0 flex-1 bg-[#0a0f1a] pt-[112px] lg:pt-0">
          <div className="relative min-h-screen">
            ...
            <div className="relative z-10 flex min-h-screen flex-col">
              ...
              <div className="grid flex-1 xl:grid-cols-[minmax(390px,500px)_1fr]">
                {/* ===================== PAINEL DE CONFIG ===================== */}
                ...
                {/* ===================== PRÉ-VISUALIZAÇÃO ===================== */}
                  ...
                  <div className="relative flex w-full max-w-[700px] items-center justify-center">
                    ...
                    {/* Mockup de celular */}
                    <div className="relative h-[640px] w-[350px] max-w-[80vw] rounded-[3.2rem] border-[10px] border-[#05070c] bg-[#05070c] shadow-[0_40px_100px_rgba(0,0,0,0.6)] ring-1 ring-white/10">
